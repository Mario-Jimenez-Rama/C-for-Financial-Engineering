...
{
    Timer t; t.start();
    volatile double sink = 0.0; // prevent DCE
...
int main(int argc, char** argv) {
    ...
    std::puts("\nTip: on Linux use perf: cycles,instructions,branches,branch-misses");
    return 0;
}
